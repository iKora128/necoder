...
（日本語要約: 本プロジェクトは誰にとっても嫌がらせのない参加体験を約束します。違反を見かけたら、
公開の場でなく下記 Enforcement の窓口へ非公開で報告してください。）
...
Consequences follow the Community Impact Guidelines of the Contributor Covenant:
correction → warning → temporary ban → permanent ban, proportional to the violation.
